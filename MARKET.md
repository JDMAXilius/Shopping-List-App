...
- ~~$19.99–24.99/yr household~~ — **superseded, see `PLAN.md` §4. Decided: $2.99/mo or
  ...
  Trial is **7 days** (`PLAN.md` §4) — note that App Store introductory offers only permit fixed
  durations, so the 17–32 day window discussed below was never selectable; the real options are
